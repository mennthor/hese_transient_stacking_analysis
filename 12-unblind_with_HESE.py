...
"""
Unblind full data with HESE events still included as a crosscheck.
"""
...
# Exchange with skylab data, which has the HESE events still included
pstracks = Datasets["PointSourceTracks"]
gfu = Datasets["GFU"]
exp_on = {}
exp_on["IC79"] = pstracks.load(pstracks.files("IC79")[0])
exp_on["IC86_2011"] = pstracks.load(pstracks.files("IC86, 2011")[0])
exp_on["IC86_2012-2014"] = pstracks.load(pstracks.files("IC86, 2012-2014")[0])
exp_on["IC86_2015"] = gfu.load(gfu.files("IC86, 2015")[0])
...
fname = os.path.join(outpath, "result_with_HESE.json")
...
dict_print(result)
if really_unblind:
    print("\n" + 60 * "#" + "NOTE: This was the result on real data!")
else:
    print("\n" + 60 * "#" + "NOTE: This was a fake unblinding!")
